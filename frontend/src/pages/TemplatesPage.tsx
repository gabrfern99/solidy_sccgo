  ...
  return (
    <div>
      <PageHeader
        ...
        actions={<button className="btn-primary" onClick={() => setOpen(true)}><Plus size={16} /> Novo Template</button>}
      />
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Novo Template" size="xl">
        <form onSubmit={save} className="space-y-4">
          ...
          <button type="submit" className="btn-primary w-full">Salvar template</button>
        </form>
      </Modal>
    </div>
  );
